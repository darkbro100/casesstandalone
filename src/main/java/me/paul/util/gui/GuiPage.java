...
public class GuiPage {
  ...
  protected CasesStandalone plugin;
   ...
   */
  public GuiPage(CasesStandalone plugin, int height) {
   ...
   */
  public GuiPage(CasesStandalone plugin, int height, String name) {
