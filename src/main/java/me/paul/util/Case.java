...
import static me.paul.util.CaseRunnable.MAX_ITEMS;
...
public class Case {
  ...
  private void spawnDisplay() {
    ...
    spawnLoc.getWorld().getNearbyEntities(spawnLoc, 5, 5, 5).forEach(ent -> {
    ...
    interactEnt.setMetadata("caseId", new FixedMetadataValue(CasesStandalone.getInstance(), id));
  }
