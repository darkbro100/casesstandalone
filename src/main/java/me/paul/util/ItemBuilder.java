...
public class ItemBuilder {
  ...
  public ItemBuilder name(Component component) {
	 ...
	 * @param duration If the potion should be extended (note some potions cannot be extended and upgraded)
	 * @param amplifier If the potion should be upgraded (note some potions cannot be extended and upgraded)
	 */
	public ItemBuilder setPotionMeta(PotionEffectType type, int duration, int amplifier) {
		try {
...
//			meta.setBasePotionData(new PotionData(type, extended, upgraded));
	...
	public ItemBuilder addAttributeModifier(@NotNull Attribute attribute, double amount, @NotNull AttributeModifier.Operation operation){
		AttributeModifier attributeModifier = new AttributeModifier(attribute.getKey(), amount, operation);
		ItemMeta meta = is.getItemMeta();
